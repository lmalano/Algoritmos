...
class Nodo{
    ...
    public:
           ...
           void set_camino(int a){camino=a;}
           int get_camino(){return camino;}
           void set_costo(int a){costototal=a;}
           int get_costo(){return costototal;}
};
...
class Lista_de_Adyacencia{
    private:
            Nodo *czo_lista;
    public:
           Lista_de_Adyacencia() {czo_lista=new Nodo();costototal=1000;};
