...
void Dijkstra:: set_desconocidos(Lista_de_Adyacencia* l){
     Nodo* n= l->get_czo_lista();
     while(n->get_nextabajo()!=NULL){
                                     if (!Conocidos.pertenece(n->get_origen())){
                                                           Desconocidos+n->get_origen();
                                     }
                                     n=n->get_nextabajo();
     }
}
...
void Dijkstra::set_predecesor_peso(Lista_de_Adyacencia* l, int posicion, int entrada){
          if(entrada==0){
                        ...
                        //creo lista de adyacencia auxiliar.
                         s=l;
                         ...
                         n=s->get_czo_lista()->get_nextderecha();if(n!=NULL){
