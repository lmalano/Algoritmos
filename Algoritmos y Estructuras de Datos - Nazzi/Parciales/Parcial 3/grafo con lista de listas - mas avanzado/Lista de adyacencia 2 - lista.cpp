...
class Nodo{
    private:
            ...
            int anterior;
    public:
           Nodo() {next_abajo=NULL;next_derecha=NULL;costototal=numeric_limits<double>::infinity();};
           ...
           void set_costototal(double a){costototal=a;}
           double get_costototal(){return costototal;}
           void set_anterior(int a){anterior=a;}
           int get_anterior(){return anterior;}
};
...
void Lista_de_Adyacencia::impresionlista(){
     if(!this->listavacia()) {
                       ...
                       if(czo_lista->get_nextderecha()!=NULL){
...
Nodo_Elementos* Lista_de_Adyacencia:: set_lista_elementos(int o, int p, int d){
                ...
                if(this->is_dato(o)){                                                           // Pregunto si el vertice de origen ya existe
                                     ...
                                     if(o==vertice_origen){
                                                           if(get_czo_lista()->get_nextderecha()==NULL){
                                                                         ...
                                                                         l->add(p,d);
                                                                         get_czo_lista()->set_nextderecha(l);
                                                           }
                                                           else{
